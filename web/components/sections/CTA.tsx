...
export function CTA() {
  return (
    <section className="cta-section" id="contact" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="cta-section__inner">
          ...
          <FadeUp delay={0.15}>
            <div className="cta-section__btns">
              <a href="mailto:hello@inovaqo.com" className="ino-btn ino-btn--primary ino-btn--lg magnetic">
